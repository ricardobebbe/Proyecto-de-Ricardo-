...
CServerDisplayer::CServerDisplayer() // OK
{
	...
	this->m_brush[3] = CreateSolidBrush(RGB(255,25,25)); //-- Fondo Principal
	this->m_brush[4] = CreateSolidBrush(RGB(255,25,25)); //-- fondo de eventos e informacion
#else
	this->m_brush[0] = CreateSolidBrush(RGB(60, 255, 51)); //-- cuando esta activo
	this->m_brush[1] = CreateSolidBrush(RGB(255,25,25)); //-- cuando esta desactivado
	...
	strcpy_s(this->m_DisplayerText[1],"MODO LIGADO");
}
