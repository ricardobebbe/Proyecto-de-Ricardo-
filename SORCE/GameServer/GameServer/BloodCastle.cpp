...
void CBloodCastle::SetState_START(BLOOD_CASTLE_LEVEL* lpLevel) // OK
{
	...
	{
		case 0:
			this->SetMonsterLevelOne(lpLevel,84);
			this->SetMonsterLevelOne(lpLevel,85);
			this->SetMonsterLevelOne(lpLevel,86);
			this->SetMonsterLevelOne(lpLevel,87);
			this->SetMonsterLevelOne(lpLevel,88);
			break;
		case 1:
			this->SetMonsterLevelTwo(lpLevel,90);
			this->SetMonsterLevelTwo(lpLevel,91);
			this->SetMonsterLevelTwo(lpLevel,92);
			this->SetMonsterLevelTwo(lpLevel,93);
			this->SetMonsterLevelTwo(lpLevel,94);
			break;
		case 2:
			this->SetMonsterLevelThe(lpLevel,96);
			this->SetMonsterLevelThe(lpLevel,97);
			this->SetMonsterLevelThe(lpLevel,98);
			this->SetMonsterLevelThe(lpLevel,99);
			this->SetMonsterLevelThe(lpLevel,111);
			break;
		case 3:
			this->SetMonsterLevelFor(lpLevel,113);
			this->SetMonsterLevelFor(lpLevel,114);
			this->SetMonsterLevelFor(lpLevel,115);
			this->SetMonsterLevelFor(lpLevel,116);
			this->SetMonsterLevelFor(lpLevel,117);
			break;
		case 4:
			this->SetMonsterLevelFiv(lpLevel,119);
			this->SetMonsterLevelFiv(lpLevel,120);
			this->SetMonsterLevelFiv(lpLevel,121);
			this->SetMonsterLevelFiv(lpLevel,122);
			this->SetMonsterLevelFiv(lpLevel,123);
			break;
		case 5:
			this->SetMonsterLevelSix(lpLevel,125);
			this->SetMonsterLevelSix(lpLevel,126);
			this->SetMonsterLevelSix(lpLevel,127);
			this->SetMonsterLevelSix(lpLevel,128);
			this->SetMonsterLevelSix(lpLevel,129);
			break;
		case 6:
			this->SetMonsterLevelSev(lpLevel,138);
			this->SetMonsterLevelSev(lpLevel,139);
			this->SetMonsterLevelSev(lpLevel,140);
			this->SetMonsterLevelSev(lpLevel,141);
			this->SetMonsterLevelSev(lpLevel,142);
			break;
		case 7:
			this->SetMonsterLevelEig(lpLevel,428);
			this->SetMonsterLevelEig(lpLevel,429);
			this->SetMonsterLevelEig(lpLevel,430);
			this->SetMonsterLevelEig(lpLevel,431);
			this->SetMonsterLevelEig(lpLevel,432);
			break;
	}
...
void CBloodCastle::SetStage2(BLOOD_CASTLE_LEVEL* lpLevel) // OK
{
	...
	{
		case 0:
			this->SetMonsterLevelOne(lpLevel,89);
			break;
		case 1:
			this->SetMonsterLevelTwo(lpLevel,95);
			break;
		case 2:
			this->SetMonsterLevelThe(lpLevel,112);
			break;
		case 3:
			this->SetMonsterLevelFor(lpLevel,118);
			break;
		case 4:
			this->SetMonsterLevelFiv(lpLevel,124);
			break;
		case 5:
			this->SetMonsterLevelSix(lpLevel,130);
			break;
		case 6:
			this->SetMonsterLevelSev(lpLevel,143);
			break;
		case 7:
			this->SetMonsterLevelEig(lpLevel,433);
			break;
	}
}
...
int CBloodCastle::GetUserAbleLevel(LPOBJ lpObj) // OK
{
	...
	if(lpObj->Class == CLASS_MG || lpObj->Class == CLASS_DL || lpObj->Class == CLASS_RF)
	{
		if(lpObj->ChangeUp < 2)
		{
			if(lpObj->Level >= 10 && lpObj->Level <= 145)
			{
				level = 0;
			}
			else if(lpObj->Level >= 50 && lpObj->Level <= 199)
			{
				level = 1;
			}
			else if(lpObj->Level >= 291 && lpObj->Level <= 435)
			{
				level = 2;
			}
			else if(lpObj->Level >= 161 && lpObj->Level <= 580)
			{
				level = 3;
			}
			else if(lpObj->Level >= 581 && lpObj->Level <= 725)
			{
				level = 4;
			}
			else if(lpObj->Level >= 726 && lpObj->Level <= 870)
			{
				level = 5;
			}
			else if(lpObj->Level >= 871 && lpObj->Level <= MAX_CHARACTER_LEVEL)
			{
				level = 6;
			}
		}
	...
	else
	{
		if(lpObj->ChangeUp < 2)
		{
			if(lpObj->Level >= 50 && lpObj->Level <= 199)
			{
				level = 0;
			}
			else if(lpObj->Level >= 200 && lpObj->Level <= 399)
			{
				level = 1;
			}
			else if(lpObj->Level >= 400 && lpObj->Level <= 600)
			{
				level = 2;
			}
			else if(lpObj->Level >= 601 && lpObj->Level <= 750)
			{
				level = 3;
			}
			else if(lpObj->Level >= 751 && lpObj->Level <= 800)
			{
				level = 4;
			}
			else if(lpObj->Level >= 801 && lpObj->Level <= 899)
			{
				level = 5;
			}
			else if(lpObj->Level >= 901 && lpObj->Level <= MAX_CHARACTER_LEVEL)
			{
				level = 6;
			}
		}
...
void CBloodCastle::SetMonsterLevelOne(BLOOD_CASTLE_LEVEL* lpLevel,int MonsterClass) // OK
{
	for(int n=0;n < gMonsterSetBaseBloodCastle.m_count;n++)
	{
		MONSTER_SET_BASE_INFO_BLOODCASTLE1* lpInfo = &gMonsterSetBaseBloodCastle.m_MonsterSetBaseInfo[n];

		if(lpInfo->Type != 4 || lpInfo->MonsterClass != MonsterClass || lpInfo->Map != 11)
		{
			continue;
		}
		...
		if(gMonsterSetBaseBloodCastle.gObjSetPosMonster(index,n) == 0)
		{
			gObjDel(index);
			continue;
		}
...
void CBloodCastle::SetMonsterLevelTwo(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass) // OK
{
	for (int n = 0; n < gMonsterSetBaseBloodCastleTwo.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_BLOODCASTLE2* lpInfo = &gMonsterSetBaseBloodCastleTwo.m_MonsterSetBaseInfo[n];

		if (lpInfo->Type != 4 || lpInfo->MonsterClass != MonsterClass || lpInfo->Map != 12)
		{
			continue;
		}
		...
		if (gMonsterSetBaseBloodCastleTwo.gObjSetPosMonster(index, n) == 0)
		{
			gObjDel(index);
			continue;
		}
...
void CBloodCastle::SetMonsterLevelThe(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass) // OK
{
	for (int n = 0; n < gMonsterSetBaseBloodCastleThe.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_BLOODCASTLE3* lpInfo = &gMonsterSetBaseBloodCastleThe.m_MonsterSetBaseInfo[n];

		if (lpInfo->Type != 4 || lpInfo->MonsterClass != MonsterClass || lpInfo->Map != 13)
		{
			continue;
		}
		...
		if (gMonsterSetBaseBloodCastleThe.gObjSetPosMonster(index, n) == 0)
		{
			gObjDel(index);
			continue;
		}
...
void CBloodCastle::SetMonsterLevelFor(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass) // OK
{
	for (int n = 0; n < gMonsterSetBaseBloodCastleFor.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_BLOODCASTLE4* lpInfo = &gMonsterSetBaseBloodCastleFor.m_MonsterSetBaseInfo[n];

		if (lpInfo->Type != 4 || lpInfo->MonsterClass != MonsterClass || lpInfo->Map != 14)
		{
			continue;
		}
		...
		if (gMonsterSetBaseBloodCastleFor.gObjSetPosMonster(index, n) == 0)
		{
			gObjDel(index);
			continue;
		}
...
void CBloodCastle::SetMonsterLevelFiv(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass) // OK
{
	for (int n = 0; n < gMonsterSetBaseBloodCastleFiv.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_BLOODCASTLE5* lpInfo = &gMonsterSetBaseBloodCastleFiv.m_MonsterSetBaseInfo[n];

		if (lpInfo->Type != 4 || lpInfo->MonsterClass != MonsterClass || lpInfo->Map != 15)
		{
			continue;
		}
		...
		if (gMonsterSetBaseBloodCastleFiv.gObjSetPosMonster(index, n) == 0)
		{
			gObjDel(index);
			continue;
		}
...
void CBloodCastle::SetMonsterLevelSix(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass) // OK
{
	for (int n = 0; n < gMonsterSetBaseBloodCastleSix.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_BLOODCASTLE6* lpInfo = &gMonsterSetBaseBloodCastleSix.m_MonsterSetBaseInfo[n];

		if (lpInfo->Type != 4 || lpInfo->MonsterClass != MonsterClass || lpInfo->Map != 16)
		{
			continue;
		}
		...
		if (gMonsterSetBaseBloodCastleSix.gObjSetPosMonster(index, n) == 0)
		{
			gObjDel(index);
			continue;
		}
...
void CBloodCastle::SetMonsterLevelSev(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass) // OK
{
	for (int n = 0; n < gMonsterSetBaseBloodCastleSev.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_BLOODCASTLE7* lpInfo = &gMonsterSetBaseBloodCastleSev.m_MonsterSetBaseInfo[n];

		if (lpInfo->Type != 4 || lpInfo->MonsterClass != MonsterClass || lpInfo->Map != 17)
		{
			continue;
		}
		...
		if (gMonsterSetBaseBloodCastleSev.gObjSetPosMonster(index, n) == 0)
		{
			gObjDel(index);
			continue;
		}
...
void CBloodCastle::SetMonsterLevelEig(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass) // OK
{
	for (int n = 0; n < gMonsterSetBaseBloodCastleEig.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_BLOODCASTLE8* lpInfo = &gMonsterSetBaseBloodCastleEig.m_MonsterSetBaseInfo[n];

		if (lpInfo->Type != 4 || lpInfo->MonsterClass != MonsterClass || lpInfo->Map != 52)
		{
			continue;
		}
		...
		if (gMonsterSetBaseBloodCastleEig.gObjSetPosMonster(index, n) == 0)
		{
			gObjDel(index);
			continue;
		}
