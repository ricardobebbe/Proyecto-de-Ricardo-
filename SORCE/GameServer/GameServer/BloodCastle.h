...
public:
	...
	void SetMonsterLevelOne(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass);
	void SetMonsterLevelTwo(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass);
	void SetMonsterLevelThe(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass);
	void SetMonsterLevelFor(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass);
	void SetMonsterLevelFiv(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass);
	void SetMonsterLevelSix(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass);
	void SetMonsterLevelSev(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass);
	void SetMonsterLevelEig(BLOOD_CASTLE_LEVEL* lpLevel, int MonsterClass);
