...
void CChaosBox::CGChaosMixRecv(PMSG_CHAOS_MIX_RECV* lpMsg,int aIndex) // OK
{
	...
	if(lpObj->Permission[9] != 0)  //ZEUS LUA UP24 
	{
		return;
	}
	...
	if (gCustomMix.CheckCustomMix(lpMsg->type) != 0)  //ZEUS UP25 CHAOSMIX 
	{
...
void CChaosBox::CGChaosMixCloseRecv(int aIndex) // OK
{
	...
	if(lpObj->Permission[9] != 0)  //ZEUS UP24 LUA
	{
		return;
	}
...
void CChaosBox::CustomMix(LPOBJ lpObj,int type) //ZEUS UP25 CHAOSMIX 
{
