...
public:
	...
	void StartCC();
	//
	void SetMonsterLevelTwo(CHAOS_CASTLE_LEVEL* lpLevel, int MonsterClass);
	void SetMonsterLevelThe(CHAOS_CASTLE_LEVEL* lpLevel, int MonsterClass);
	void SetMonsterLevelFor(CHAOS_CASTLE_LEVEL* lpLevel, int MonsterClass);
	void SetMonsterLevelFiv(CHAOS_CASTLE_LEVEL* lpLevel, int MonsterClass);
	void SetMonsterLevelSix(CHAOS_CASTLE_LEVEL* lpLevel, int MonsterClass);
	void SetMonsterLevelSev(CHAOS_CASTLE_LEVEL* lpLevel, int MonsterClass);
private:
