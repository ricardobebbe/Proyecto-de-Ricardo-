...
{
	s_FakeOnline.FakeAttackProc(lpObj); //ZEUS UP18 FAKE Attack, Move
...
void CCustomAttack::DGCustomAttackResumeSaveSend(int Index)
{
	...
	pMsg.autoreset =  ( gServerInfo.m_CommandResetAutoEnable[lpObj->AccountLevel] == 0 ) ? 0 : lpObj->AutoResetEnable;
