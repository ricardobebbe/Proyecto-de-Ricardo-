...
void CDevilSquare::SetState_START(DEVIL_SQUARE_LEVEL* lpLevel) // OK
{
	...
	switch(lpLevel->Level)
	{
		...
		case 3:
			...
			break;
		case 4:
			this->SetMonsterTwo(lpLevel,60);
			this->SetMonsterTwo(lpLevel,62);
			break;
		case 5:
			this->SetMonsterTwo(lpLevel,69);
			this->SetMonsterTwo(lpLevel,71);
			break;
		case 6:
			this->SetMonsterTwo(lpLevel,434);
			this->SetMonsterTwo(lpLevel,435);
			break;
	}
...
void CDevilSquare::SetStage0(DEVIL_SQUARE_LEVEL* lpLevel) // OK
{
	...
	switch(lpLevel->Level)
	{
		...
		case 3:
			...
			break;
		case 4:
			this->SetMonsterTwo(lpLevel,57);
			this->SetMonsterTwo(lpLevel,58);
			break;
		case 5:
			this->SetMonsterTwo(lpLevel,73);
			this->SetMonsterTwo(lpLevel,74);
			break;
		case 6:
			this->SetMonsterTwo(lpLevel,436);
			this->SetMonsterTwo(lpLevel,437);
			break;
	}
}
...
void CDevilSquare::SetStage1(DEVIL_SQUARE_LEVEL* lpLevel) // OK
{
	...
	switch(lpLevel->Level)
	{
		...
		case 3:
			...
			break;
		case 4:
			this->SetMonsterTwo(lpLevel,292);
			this->SetMonsterTwo(lpLevel,293);
			break;
		case 5:
			this->SetMonsterTwo(lpLevel,72);
			this->SetMonsterTwo(lpLevel,75);
			break;
		case 6:
			this->SetMonsterTwo(lpLevel,438);
			this->SetMonsterTwo(lpLevel,439);
			break;
	}
}
...
void CDevilSquare::SetStage2(DEVIL_SQUARE_LEVEL* lpLevel) // OK
{
	...
	switch(lpLevel->Level)
	{
		...
		case 3:
			...
			break;
		case 4:
			this->SetMonsterTwo(lpLevel,291);
			break;
		case 5:
			this->SetMonsterTwo(lpLevel,77);
			break;
		case 6:
			this->SetMonsterTwo(lpLevel,440);
			break;
	}
}
...
{
	for(int n=0;n < gMonsterSetBaseDevilSquareOne.m_count;n++)
	{
		MONSTER_SET_BASE_INFO_DEVILSQUARE1* lpInfo = &gMonsterSetBaseDevilSquareOne.m_MonsterSetBaseInfo[n];

		if(lpInfo->Type != 4 || lpInfo->MonsterClass != MonsterClass || lpInfo->Map != 9)
		{
			continue;
		}
		...
		if(gMonsterSetBaseDevilSquareOne.gObjSetPosMonster(index,n) == 0)
		{
			gObjDel(index);
			continue;
		}
...
void CDevilSquare::SetMonsterTwo(DEVIL_SQUARE_LEVEL* lpLevel, int MonsterClass) // OK
{
	for (int n = 0; n < gMonsterSetBaseDevilSquareTwo.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_DEVILSQUARE2* lpInfo = &gMonsterSetBaseDevilSquareTwo.m_MonsterSetBaseInfo[n];

		if (lpInfo->Type != 4 || lpInfo->MonsterClass != MonsterClass || lpInfo->Map != 32)
		{
			continue;
		}
		...
		if (gMonsterSetBaseDevilSquareTwo.gObjSetPosMonster(index, n) == 0)
		{
			gObjDel(index);
			continue;
		}
