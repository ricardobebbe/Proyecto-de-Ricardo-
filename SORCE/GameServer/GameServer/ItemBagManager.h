...
enum eItemBagSpecialValue
{
	...
	ITEM_BAG_GIFT = 61,
	ITEM_BAG_MRESET = 62,
	ITEM_BAG_DEVIL_SQUARE1 = 63,
	ITEM_BAG_DEVIL_SQUARE2 = 64,
	ITEM_BAG_DEVIL_SQUARE3 = 65,
	ITEM_BAG_DEVIL_SQUARE4 = 66,
	ITEM_BAG_DEVIL_SQUARE5 = 67,
	ITEM_BAG_DEVIL_SQUARE6 = 68,
	ITEM_BAG_DEVIL_SQUARE7 = 69,
};
...
struct ITEM_BAG_MANAGER_SPECIAL_INFO    //ZEUSS UP24 LUA
{
	int SpecialValue;
	int SpecialLevel;
	int SpecialState;
...
public:
	...
	bool DropItemBySpecialValue(int SpecialValue,int SpecialLevel,int SpecialState,LPOBJ lpObj,int map,int x,int y);  //ZEUSS UP24 LUA
private:
	std::map<int,ITEM_BAG_MANAGER_INFO> m_ItemBagManagerInfo;

	std::vector<ITEM_BAG_MANAGER_SPECIAL_INFO> m_ItemBagManagerSpecialInfo;   //ZEUS UP24 LUA
};
