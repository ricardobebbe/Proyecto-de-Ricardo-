// MonsterSetBase.cpp: implementation of the CMonsterSetBaseAida class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseAida gMonsterSetBaseAida;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseAida::CMonsterSetBaseAida() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseAida::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_AIDA info;
...
void CMonsterSetBaseAida::SetInfo(MONSTER_SET_BASE_INFO_AIDA info) // OK
{
...
bool CMonsterSetBaseAida::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_AIDA* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseAida::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseAida::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseAida::SetMonsterDataAida() // OK
{
	for (int n = 0; n < gMonsterSetBaseAida.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_AIDA* lpInfo = &gMonsterSetBaseAida.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseAida::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_AIDA* lpInfo = &gMonsterSetBaseAida.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseAida.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
