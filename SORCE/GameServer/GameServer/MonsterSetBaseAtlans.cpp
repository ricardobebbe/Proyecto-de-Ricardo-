// MonsterSetBase.cpp: implementation of the CMonsterSetBaseAtlans class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseAtlans gMonsterSetBaseAtlans;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseAtlans::CMonsterSetBaseAtlans() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseAtlans::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_ATLANS info;
...
void CMonsterSetBaseAtlans::SetInfo(MONSTER_SET_BASE_INFO_ATLANS info) // OK
{
...
bool CMonsterSetBaseAtlans::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_ATLANS* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseAtlans::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseAtlans::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseAtlans::SetMonsterDataAtlans() // OK
{
	for (int n = 0; n < gMonsterSetBaseAtlans.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_ATLANS* lpInfo = &gMonsterSetBaseAtlans.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseAtlans::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_ATLANS* lpInfo = &gMonsterSetBaseAtlans.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseAtlans.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
