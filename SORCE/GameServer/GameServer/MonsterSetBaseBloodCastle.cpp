// MonsterSetBase.cpp: implementation of the CMonsterSetBaseBloodCastle class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseBloodCastle gMonsterSetBaseBloodCastle;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseBloodCastle::CMonsterSetBaseBloodCastle() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseBloodCastle::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_BLOODCASTLE1 info;
...
void CMonsterSetBaseBloodCastle::SetInfo(MONSTER_SET_BASE_INFO_BLOODCASTLE1 info) // OK
{
...
bool CMonsterSetBaseBloodCastle::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE1* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseBloodCastle::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseBloodCastle::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseBloodCastle::SetMonsterDataBloodCastle() // OK
{
...
bool CMonsterSetBaseBloodCastle::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE1* lpInfo = &gMonsterSetBaseBloodCastle.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseBloodCastle.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
