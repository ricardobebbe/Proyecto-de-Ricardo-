// MonsterSetBase.cpp: implementation of the CMonsterSetBaseBloodCastleEig class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseBloodCastleEig gMonsterSetBaseBloodCastleEig;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseBloodCastleEig::CMonsterSetBaseBloodCastleEig() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseBloodCastleEig::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_BLOODCASTLE8 info;
...
void CMonsterSetBaseBloodCastleEig::SetInfo(MONSTER_SET_BASE_INFO_BLOODCASTLE8 info) // OK
{
...
bool CMonsterSetBaseBloodCastleEig::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE8* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseBloodCastleEig::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseBloodCastleEig::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseBloodCastleEig::SetMonsterDataBloodCastleEig() // OK
{
...
bool CMonsterSetBaseBloodCastleEig::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE8* lpInfo = &gMonsterSetBaseBloodCastleEig.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseBloodCastleEig.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
