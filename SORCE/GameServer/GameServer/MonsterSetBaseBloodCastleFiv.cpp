// MonsterSetBase.cpp: implementation of the CMonsterSetBaseBloodCastleFiv class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseBloodCastleFiv gMonsterSetBaseBloodCastleFiv;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseBloodCastleFiv::CMonsterSetBaseBloodCastleFiv() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseBloodCastleFiv::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_BLOODCASTLE5 info;
...
void CMonsterSetBaseBloodCastleFiv::SetInfo(MONSTER_SET_BASE_INFO_BLOODCASTLE5 info) // OK
{
...
bool CMonsterSetBaseBloodCastleFiv::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE5* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseBloodCastleFiv::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseBloodCastleFiv::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseBloodCastleFiv::SetMonsterDataBloodCastleFiv() // OK
{
...
bool CMonsterSetBaseBloodCastleFiv::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE5* lpInfo = &gMonsterSetBaseBloodCastleFiv.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseBloodCastleFiv.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
