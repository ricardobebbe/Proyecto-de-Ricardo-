// MonsterSetBase.cpp: implementation of the CMonsterSetBaseBloodCastleFor class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseBloodCastleFor gMonsterSetBaseBloodCastleFor;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseBloodCastleFor::CMonsterSetBaseBloodCastleFor() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseBloodCastleFor::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_BLOODCASTLE4 info;
...
void CMonsterSetBaseBloodCastleFor::SetInfo(MONSTER_SET_BASE_INFO_BLOODCASTLE4 info) // OK
{
...
bool CMonsterSetBaseBloodCastleFor::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE4* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseBloodCastleFor::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseBloodCastleFor::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseBloodCastleFor::SetMonsterDataBloodCastleFor() // OK
{
...
bool CMonsterSetBaseBloodCastleFor::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE4* lpInfo = &gMonsterSetBaseBloodCastleFor.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseBloodCastleFor.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
