// MonsterSetBase.cpp: implementation of the CMonsterSetBaseBloodCastleSev class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseBloodCastleSev gMonsterSetBaseBloodCastleSev;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseBloodCastleSev::CMonsterSetBaseBloodCastleSev() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseBloodCastleSev::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_BLOODCASTLE7 info;
...
void CMonsterSetBaseBloodCastleSev::SetInfo(MONSTER_SET_BASE_INFO_BLOODCASTLE7 info) // OK
{
...
bool CMonsterSetBaseBloodCastleSev::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE7* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseBloodCastleSev::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseBloodCastleSev::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseBloodCastleSev::SetMonsterDataBloodCastleSev() // OK
{
...
bool CMonsterSetBaseBloodCastleSev::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE7* lpInfo = &gMonsterSetBaseBloodCastleSev.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseBloodCastleSev.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
