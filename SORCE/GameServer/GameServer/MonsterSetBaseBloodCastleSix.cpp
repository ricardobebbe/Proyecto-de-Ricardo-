// MonsterSetBase.cpp: implementation of the CMonsterSetBaseBloodCastleSix class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseBloodCastleSix gMonsterSetBaseBloodCastleSix;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseBloodCastleSix::CMonsterSetBaseBloodCastleSix() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseBloodCastleSix::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_BLOODCASTLE6 info;
...
void CMonsterSetBaseBloodCastleSix::SetInfo(MONSTER_SET_BASE_INFO_BLOODCASTLE6 info) // OK
{
...
bool CMonsterSetBaseBloodCastleSix::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE6* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseBloodCastleSix::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseBloodCastleSix::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseBloodCastleSix::SetMonsterDataBloodCastleSix() // OK
{
...
bool CMonsterSetBaseBloodCastleSix::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE6* lpInfo = &gMonsterSetBaseBloodCastleSix.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseBloodCastleSix.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
