// MonsterSetBase.cpp: implementation of the CMonsterSetBaseBloodCastleThe class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseBloodCastleThe gMonsterSetBaseBloodCastleThe;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseBloodCastleThe::CMonsterSetBaseBloodCastleThe() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseBloodCastleThe::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_BLOODCASTLE3 info;
...
void CMonsterSetBaseBloodCastleThe::SetInfo(MONSTER_SET_BASE_INFO_BLOODCASTLE3 info) // OK
{
...
bool CMonsterSetBaseBloodCastleThe::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE3* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseBloodCastleThe::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseBloodCastleThe::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseBloodCastleThe::SetMonsterDataBloodCastleThe() // OK
{
...
bool CMonsterSetBaseBloodCastleThe::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE3* lpInfo = &gMonsterSetBaseBloodCastleThe.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseBloodCastleThe.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
