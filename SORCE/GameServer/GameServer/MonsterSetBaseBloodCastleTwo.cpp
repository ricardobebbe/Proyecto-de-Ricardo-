// MonsterSetBase.cpp: implementation of the CMonsterSetBaseBloodCastleTwo class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseBloodCastleTwo gMonsterSetBaseBloodCastleTwo;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseBloodCastleTwo::CMonsterSetBaseBloodCastleTwo() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseBloodCastleTwo::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_BLOODCASTLE2 info;
...
void CMonsterSetBaseBloodCastleTwo::SetInfo(MONSTER_SET_BASE_INFO_BLOODCASTLE2 info) // OK
{
...
bool CMonsterSetBaseBloodCastleTwo::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE2* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseBloodCastleTwo::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseBloodCastleTwo::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseBloodCastleTwo::SetMonsterDataBloodCastleTwo() // OK
{
...
bool CMonsterSetBaseBloodCastleTwo::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_BLOODCASTLE2* lpInfo = &gMonsterSetBaseBloodCastleTwo.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseBloodCastleTwo.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
