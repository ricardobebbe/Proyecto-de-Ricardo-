// MonsterSetBase.cpp: implementation of the CMonsterSetBaseChaosCastleFiv class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseChaosCastleFiv gMonsterSetBaseChaosCastleFiv;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseChaosCastleFiv::CMonsterSetBaseChaosCastleFiv() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseChaosCastleFiv::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_CHAOSCASTLE5 info;
...
void CMonsterSetBaseChaosCastleFiv::SetInfo(MONSTER_SET_BASE_INFO_CHAOSCASTLE5 info) // OK
{
...
bool CMonsterSetBaseChaosCastleFiv::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_CHAOSCASTLE5* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseChaosCastleFiv::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseChaosCastleFiv::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseChaosCastleFiv::SetMonsterDataChaosCastleFiv() // OK
{
...
bool CMonsterSetBaseChaosCastleFiv::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_CHAOSCASTLE5* lpInfo = &gMonsterSetBaseChaosCastleFiv.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseChaosCastleFiv.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
