// MonsterSetBase.cpp: implementation of the CMonsterSetBaseChaosCastleFor class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseChaosCastleFor gMonsterSetBaseChaosCastleFor;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseChaosCastleFor::CMonsterSetBaseChaosCastleFor() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseChaosCastleFor::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_CHAOSCASTLE4 info;
...
void CMonsterSetBaseChaosCastleFor::SetInfo(MONSTER_SET_BASE_INFO_CHAOSCASTLE4 info) // OK
{
...
bool CMonsterSetBaseChaosCastleFor::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_CHAOSCASTLE4* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseChaosCastleFor::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseChaosCastleFor::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseChaosCastleFor::SetMonsterDataChaosCastleFor() // OK
{
...
bool CMonsterSetBaseChaosCastleFor::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_CHAOSCASTLE4* lpInfo = &gMonsterSetBaseChaosCastleFor.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseChaosCastleFor.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
