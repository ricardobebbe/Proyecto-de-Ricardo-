// MonsterSetBase.cpp: implementation of the CMonsterSetBaseChaosCastle class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseChaosCastle gMonsterSetBaseChaosCastle;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseChaosCastle::CMonsterSetBaseChaosCastle() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseChaosCastle::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_CHAOSCASTLE1 info;
...
void CMonsterSetBaseChaosCastle::SetInfo(MONSTER_SET_BASE_INFO_CHAOSCASTLE1 info) // OK
{
...
bool CMonsterSetBaseChaosCastle::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_CHAOSCASTLE1* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseChaosCastle::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseChaosCastle::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseChaosCastle::SetMonsterDataChaosCastle() // OK
{
...
bool CMonsterSetBaseChaosCastle::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_CHAOSCASTLE1* lpInfo = &gMonsterSetBaseChaosCastle.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseChaosCastle.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
