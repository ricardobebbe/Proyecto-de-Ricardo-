// MonsterSetBase.cpp: implementation of the CMonsterSetBaseChaosCastleSev class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseChaosCastleSev gMonsterSetBaseChaosCastleSev;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseChaosCastleSev::CMonsterSetBaseChaosCastleSev() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseChaosCastleSev::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_CHAOSCASTLE7 info;
...
void CMonsterSetBaseChaosCastleSev::SetInfo(MONSTER_SET_BASE_INFO_CHAOSCASTLE7 info) // OK
{
...
bool CMonsterSetBaseChaosCastleSev::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_CHAOSCASTLE7* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseChaosCastleSev::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseChaosCastleSev::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseChaosCastleSev::SetMonsterDataChaosCastleSev() // OK
{
...
bool CMonsterSetBaseChaosCastleSev::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_CHAOSCASTLE7* lpInfo = &gMonsterSetBaseChaosCastleSev.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseChaosCastleSev.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
