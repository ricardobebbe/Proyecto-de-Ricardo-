// MonsterSetBase.cpp: implementation of the CMonsterSetBaseChaosCastleSix class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseChaosCastleSix gMonsterSetBaseChaosCastleSix;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseChaosCastleSix::CMonsterSetBaseChaosCastleSix() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseChaosCastleSix::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_CHAOSCASTLE6 info;
...
void CMonsterSetBaseChaosCastleSix::SetInfo(MONSTER_SET_BASE_INFO_CHAOSCASTLE6 info) // OK
{
...
bool CMonsterSetBaseChaosCastleSix::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_CHAOSCASTLE6* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseChaosCastleSix::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseChaosCastleSix::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseChaosCastleSix::SetMonsterDataChaosCastleSix() // OK
{
...
bool CMonsterSetBaseChaosCastleSix::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_CHAOSCASTLE6* lpInfo = &gMonsterSetBaseChaosCastleSix.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseChaosCastleSix.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
