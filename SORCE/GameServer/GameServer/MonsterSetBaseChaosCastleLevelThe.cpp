// MonsterSetBase.cpp: implementation of the CMonsterSetBaseChaosCastleThe class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseChaosCastleThe gMonsterSetBaseChaosCastleThe;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseChaosCastleThe::CMonsterSetBaseChaosCastleThe() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseChaosCastleThe::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_CHAOSCASTLE3 info;
...
void CMonsterSetBaseChaosCastleThe::SetInfo(MONSTER_SET_BASE_INFO_CHAOSCASTLE3 info) // OK
{
...
bool CMonsterSetBaseChaosCastleThe::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_CHAOSCASTLE3* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseChaosCastleThe::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseChaosCastleThe::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseChaosCastleThe::SetMonsterDataChaosCastleThe() // OK
{
...
bool CMonsterSetBaseChaosCastleThe::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_CHAOSCASTLE3* lpInfo = &gMonsterSetBaseChaosCastleThe.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseChaosCastleThe.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
