// MonsterSetBase.cpp: implementation of the CMonsterSetBaseChaosCastleTwo class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseChaosCastleTwo gMonsterSetBaseChaosCastleTwo;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseChaosCastleTwo::CMonsterSetBaseChaosCastleTwo() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseChaosCastleTwo::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_CHAOSCASTLE2 info;
...
void CMonsterSetBaseChaosCastleTwo::SetInfo(MONSTER_SET_BASE_INFO_CHAOSCASTLE2 info) // OK
{
...
bool CMonsterSetBaseChaosCastleTwo::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_CHAOSCASTLE2* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseChaosCastleTwo::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseChaosCastleTwo::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseChaosCastleTwo::SetMonsterDataChaosCastleTwo() // OK
{
...
bool CMonsterSetBaseChaosCastleTwo::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_CHAOSCASTLE2* lpInfo = &gMonsterSetBaseChaosCastleTwo.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseChaosCastleTwo.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
