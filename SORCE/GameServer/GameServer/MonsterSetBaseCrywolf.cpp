// MonsterSetBase.cpp: implementation of the CMonsterSetBaseCrywolf class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseCrywolf gMonsterSetBaseCrywolf;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseCrywolf::CMonsterSetBaseCrywolf() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseCrywolf::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_CRYWOLF info;
...
void CMonsterSetBaseCrywolf::SetInfo(MONSTER_SET_BASE_INFO_CRYWOLF info) // OK
{
...
bool CMonsterSetBaseCrywolf::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_CRYWOLF* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseCrywolf::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseCrywolf::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseCrywolf::SetMonsterDataCrywolf() // OK
{
	for (int n = 0; n < gMonsterSetBaseCrywolf.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_CRYWOLF* lpInfo = &gMonsterSetBaseCrywolf.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseCrywolf::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_CRYWOLF* lpInfo = &gMonsterSetBaseCrywolf.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseCrywolf.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
