// MonsterSetBase.cpp: implementation of the CMonsterSetBaseCustomFiv class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseCustomFiv gMonsterSetBaseCustomFiv;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseCustomFiv::CMonsterSetBaseCustomFiv() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseCustomFiv::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_CUSTOM5 info;
...
void CMonsterSetBaseCustomFiv::SetInfo(MONSTER_SET_BASE_INFO_CUSTOM5 info) // OK
{
...
bool CMonsterSetBaseCustomFiv::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_CUSTOM5* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseCustomFiv::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseCustomFiv::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseCustomFiv::SetMonsterDataCustomFiv() // OK
{
	for (int n = 0; n < gMonsterSetBaseCustomFiv.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_CUSTOM5* lpInfo = &gMonsterSetBaseCustomFiv.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseCustomFiv::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_CUSTOM5* lpInfo = &gMonsterSetBaseCustomFiv.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseCustomFiv.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
