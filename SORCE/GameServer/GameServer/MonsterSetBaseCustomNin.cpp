// MonsterSetBase.cpp: implementation of the CMonsterSetBaseCustomNin class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseCustomNin gMonsterSetBaseCustomNin;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseCustomNin::CMonsterSetBaseCustomNin() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseCustomNin::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_CUSTOM9 info;
...
void CMonsterSetBaseCustomNin::SetInfo(MONSTER_SET_BASE_INFO_CUSTOM9 info) // OK
{
...
bool CMonsterSetBaseCustomNin::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_CUSTOM9* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseCustomNin::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseCustomNin::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseCustomNin::SetMonsterDataCustomNin() // OK
{
	for (int n = 0; n < gMonsterSetBaseCustomNin.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_CUSTOM9* lpInfo = &gMonsterSetBaseCustomNin.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseCustomNin::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_CUSTOM9* lpInfo = &gMonsterSetBaseCustomNin.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseCustomNin.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
