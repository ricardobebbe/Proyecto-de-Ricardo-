// MonsterSetBase.cpp: implementation of the CMonsterSetBaseCustomOne class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseCustomOne gMonsterSetBaseCustomOne;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseCustomOne::CMonsterSetBaseCustomOne() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseCustomOne::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_CUSTOM1 info;
...
void CMonsterSetBaseCustomOne::SetInfo(MONSTER_SET_BASE_INFO_CUSTOM1 info) // OK
{
...
bool CMonsterSetBaseCustomOne::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_CUSTOM1* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseCustomOne::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseCustomOne::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseCustomOne::SetMonsterDataCustomOne() // OK
{
	for (int n = 0; n < gMonsterSetBaseCustomOne.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_CUSTOM1* lpInfo = &gMonsterSetBaseCustomOne.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseCustomOne::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_CUSTOM1* lpInfo = &gMonsterSetBaseCustomOne.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseCustomOne.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
