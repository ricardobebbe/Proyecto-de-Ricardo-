// MonsterSetBase.cpp: implementation of the CMonsterSetBaseCustomThe class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseCustomThe gMonsterSetBaseCustomThe;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseCustomThe::CMonsterSetBaseCustomThe() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseCustomThe::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_CUSTOM3 info;
...
void CMonsterSetBaseCustomThe::SetInfo(MONSTER_SET_BASE_INFO_CUSTOM3 info) // OK
{
...
bool CMonsterSetBaseCustomThe::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_CUSTOM3* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseCustomThe::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseCustomThe::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseCustomThe::SetMonsterDataCustomThe() // OK
{
	for (int n = 0; n < gMonsterSetBaseCustomThe.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_CUSTOM3* lpInfo = &gMonsterSetBaseCustomThe.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseCustomThe::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_CUSTOM3* lpInfo = &gMonsterSetBaseCustomThe.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseCustomThe.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
