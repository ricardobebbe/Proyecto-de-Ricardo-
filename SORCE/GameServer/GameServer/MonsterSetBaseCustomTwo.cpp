// MonsterSetBase.cpp: implementation of the CMonsterSetBaseCustomTwo class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseCustomTwo gMonsterSetBaseCustomTwo;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseCustomTwo::CMonsterSetBaseCustomTwo() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseCustomTwo::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_CUSTOM2 info;
...
void CMonsterSetBaseCustomTwo::SetInfo(MONSTER_SET_BASE_INFO_CUSTOM2 info) // OK
{
...
bool CMonsterSetBaseCustomTwo::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_CUSTOM2* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseCustomTwo::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseCustomTwo::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseCustomTwo::SetMonsterDataCustomTwo() // OK
{
	for (int n = 0; n < gMonsterSetBaseCustomTwo.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_CUSTOM2* lpInfo = &gMonsterSetBaseCustomTwo.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseCustomTwo::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_CUSTOM2* lpInfo = &gMonsterSetBaseCustomTwo.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseCustomTwo.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
