// MonsterSetBase.cpp: implementation of the CMonsterSetBaseDevilSquareOne class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseDevilSquareOne gMonsterSetBaseDevilSquareOne;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseDevilSquareOne::CMonsterSetBaseDevilSquareOne() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseDevilSquareOne::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_DEVILSQUARE1 info;
...
void CMonsterSetBaseDevilSquareOne::SetInfo(MONSTER_SET_BASE_INFO_DEVILSQUARE1 info) // OK
{
...
bool CMonsterSetBaseDevilSquareOne::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_DEVILSQUARE1* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseDevilSquareOne::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseDevilSquareOne::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseDevilSquareOne::SetMonsterDataDevilSquareOne() // OK
{
...
bool CMonsterSetBaseDevilSquareOne::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_DEVILSQUARE1* lpInfo = &gMonsterSetBaseDevilSquareOne.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseDevilSquareOne.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
