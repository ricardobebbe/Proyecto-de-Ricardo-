// MonsterSetBase.cpp: implementation of the CMonsterSetBaseDevilSquareTwo class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseDevilSquareTwo gMonsterSetBaseDevilSquareTwo;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseDevilSquareTwo::CMonsterSetBaseDevilSquareTwo() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseDevilSquareTwo::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_DEVILSQUARE2 info;
...
void CMonsterSetBaseDevilSquareTwo::SetInfo(MONSTER_SET_BASE_INFO_DEVILSQUARE2 info) // OK
{
...
bool CMonsterSetBaseDevilSquareTwo::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_DEVILSQUARE2* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseDevilSquareTwo::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseDevilSquareTwo::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseDevilSquareTwo::SetMonsterDataDevilSquareTwo() // OK
{
...
bool CMonsterSetBaseDevilSquareTwo::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_DEVILSQUARE2* lpInfo = &gMonsterSetBaseDevilSquareTwo.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseDevilSquareTwo.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
