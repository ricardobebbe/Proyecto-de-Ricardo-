// MonsterSetBase.cpp: implementation of the CMonsterSetBaseElbeland class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseElbeland gMonsterSetBaseElbeland;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseElbeland::CMonsterSetBaseElbeland() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseElbeland::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_ELBELAND info;
...
void CMonsterSetBaseElbeland::SetInfo(MONSTER_SET_BASE_INFO_ELBELAND info) // OK
{
...
bool CMonsterSetBaseElbeland::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_ELBELAND* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseElbeland::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseElbeland::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseElbeland::SetMonsterDataElbeland() // OK
{
	for (int n = 0; n < gMonsterSetBaseElbeland.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_ELBELAND* lpInfo = &gMonsterSetBaseElbeland.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseElbeland::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_ELBELAND* lpInfo = &gMonsterSetBaseElbeland.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseElbeland.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
