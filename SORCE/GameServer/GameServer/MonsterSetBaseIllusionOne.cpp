// MonsterSetBase.cpp: implementation of the CMonsterSetBaseIllusionOne class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseIllusionOne gMonsterSetBaseIllusionOne;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseIllusionOne::CMonsterSetBaseIllusionOne() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseIllusionOne::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_ILLUSIONTEMPLE1 info;
...
void CMonsterSetBaseIllusionOne::SetInfo(MONSTER_SET_BASE_INFO_ILLUSIONTEMPLE1 info) // OK
{
...
bool CMonsterSetBaseIllusionOne::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_ILLUSIONTEMPLE1* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseIllusionOne::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseIllusionOne::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseIllusionOne::SetMonsterDataIllusionOne() // OK
{
	for (int n = 0; n < gMonsterSetBaseIllusionOne.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_ILLUSIONTEMPLE1* lpInfo = &gMonsterSetBaseIllusionOne.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseIllusionOne::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_ILLUSIONTEMPLE1* lpInfo = &gMonsterSetBaseIllusionOne.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseIllusionOne.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
