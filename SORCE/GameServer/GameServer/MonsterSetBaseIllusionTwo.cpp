// MonsterSetBase.cpp: implementation of the CMonsterSetBaseIllusionTwo class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseIllusionTwo gMonsterSetBaseIllusionTwo;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseIllusionTwo::CMonsterSetBaseIllusionTwo() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseIllusionTwo::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_ILLUSIONTEMPLE2 info;
...
void CMonsterSetBaseIllusionTwo::SetInfo(MONSTER_SET_BASE_INFO_ILLUSIONTEMPLE2 info) // OK
{
...
bool CMonsterSetBaseIllusionTwo::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_ILLUSIONTEMPLE2* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseIllusionTwo::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseIllusionTwo::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseIllusionTwo::SetMonsterDataIllusionTwo() // OK
{
	for (int n = 0; n < gMonsterSetBaseIllusionTwo.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_ILLUSIONTEMPLE2* lpInfo = &gMonsterSetBaseIllusionTwo.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseIllusionTwo::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_ILLUSIONTEMPLE2* lpInfo = &gMonsterSetBaseIllusionTwo.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseIllusionTwo.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
