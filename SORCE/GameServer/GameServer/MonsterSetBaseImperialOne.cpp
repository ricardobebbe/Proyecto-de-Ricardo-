// MonsterSetBase.cpp: implementation of the CMonsterSetBaseImperialOne class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseImperialOne gMonsterSetBaseImperialOne;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseImperialOne::CMonsterSetBaseImperialOne() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseImperialOne::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_IMPERIAL1 info;
...
void CMonsterSetBaseImperialOne::SetInfo(MONSTER_SET_BASE_INFO_IMPERIAL1 info) // OK
{
...
bool CMonsterSetBaseImperialOne::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_IMPERIAL1* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseImperialOne::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseImperialOne::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseImperialOne::SetMonsterDataImperialOne() // OK
{
	for (int n = 0; n < gMonsterSetBaseImperialOne.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_IMPERIAL1* lpInfo = &gMonsterSetBaseImperialOne.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseImperialOne::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_IMPERIAL1* lpInfo = &gMonsterSetBaseImperialOne.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseImperialOne.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
