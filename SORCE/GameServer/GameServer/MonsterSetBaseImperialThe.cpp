// MonsterSetBase.cpp: implementation of the CMonsterSetBaseImperialThe class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseImperialThe gMonsterSetBaseImperialThe;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseImperialThe::CMonsterSetBaseImperialThe() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseImperialThe::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_IMPERIAL3 info;
...
void CMonsterSetBaseImperialThe::SetInfo(MONSTER_SET_BASE_INFO_IMPERIAL3 info) // OK
{
...
bool CMonsterSetBaseImperialThe::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_IMPERIAL3* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseImperialThe::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseImperialThe::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseImperialThe::SetMonsterDataImperialThe() // OK
{
	for (int n = 0; n < gMonsterSetBaseImperialThe.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_IMPERIAL3* lpInfo = &gMonsterSetBaseImperialThe.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseImperialThe::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_IMPERIAL3* lpInfo = &gMonsterSetBaseImperialThe.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseImperialThe.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
