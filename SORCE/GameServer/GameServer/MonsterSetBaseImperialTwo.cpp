// MonsterSetBase.cpp: implementation of the CMonsterSetBaseImperialTwo class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseImperialTwo gMonsterSetBaseImperialTwo;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseImperialTwo::CMonsterSetBaseImperialTwo() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseImperialTwo::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_IMPERIAL2 info;
...
void CMonsterSetBaseImperialTwo::SetInfo(MONSTER_SET_BASE_INFO_IMPERIAL2 info) // OK
{
...
bool CMonsterSetBaseImperialTwo::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_IMPERIAL2* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseImperialTwo::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseImperialTwo::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseImperialTwo::SetMonsterDataImperialTwo() // OK
{
	for (int n = 0; n < gMonsterSetBaseImperialTwo.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_IMPERIAL2* lpInfo = &gMonsterSetBaseImperialTwo.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseImperialTwo::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_IMPERIAL2* lpInfo = &gMonsterSetBaseImperialTwo.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseImperialTwo.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
