// MonsterSetBase.cpp: implementation of the CMonsterSetBaseInvasion class.
//
//////////////////////////////////////////////////////////////////////
...
#include "ReiDoMu.h"
#include "MonsterSetBaseInvasion.h"
CMonsterSetBaseInvasion gMonsterSetBaseInvasion;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseInvasion::CMonsterSetBaseInvasion() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseInvasion::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_INVASION info;
...
void CMonsterSetBaseInvasion::SetInfo(MONSTER_SET_BASE_INFO_INVASION info) // OK
{
...
bool CMonsterSetBaseInvasion::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_INVASION* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseInvasion::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseInvasion::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseInvasion::SetMonsterDataInvasion() // OK
{
	for (int n = 0; n < gMonsterSetBaseInvasion.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_INVASION* lpInfo = &gMonsterSetBaseInvasion.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseInvasion::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_INVASION* lpInfo = &gMonsterSetBaseInvasion.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseInvasion.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
