// MonsterSetBase.cpp: implementation of the CMonsterSetBaseKalimaSeven class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseKalimaSeven gMonsterSetBaseKalimaSeven;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseKalimaSeven::CMonsterSetBaseKalimaSeven() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseKalimaSeven::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_KALIMA7 info;
...
void CMonsterSetBaseKalimaSeven::SetInfo(MONSTER_SET_BASE_INFO_KALIMA7 info) // OK
{
...
bool CMonsterSetBaseKalimaSeven::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_KALIMA7* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseKalimaSeven::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseKalimaSeven::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseKalimaSeven::SetMonsterDataKalimaSeven() // OK
{
	for (int n = 0; n < gMonsterSetBaseKalimaSeven.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_KALIMA7* lpInfo = &gMonsterSetBaseKalimaSeven.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseKalimaSeven::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_KALIMA7* lpInfo = &gMonsterSetBaseKalimaSeven.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseKalimaSeven.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
