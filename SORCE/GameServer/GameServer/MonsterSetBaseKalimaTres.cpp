// MonsterSetBase.cpp: implementation of the CMonsterSetBaseKalimaThree class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseKalimaThree gMonsterSetBaseKalimaThree;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseKalimaThree::CMonsterSetBaseKalimaThree() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseKalimaThree::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_KALIMA3 info;
...
void CMonsterSetBaseKalimaThree::SetInfo(MONSTER_SET_BASE_INFO_KALIMA3 info) // OK
{
...
bool CMonsterSetBaseKalimaThree::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_KALIMA3* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseKalimaThree::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseKalimaThree::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseKalimaThree::SetMonsterDataKalimaThree() // OK
{
	for (int n = 0; n < gMonsterSetBaseKalimaThree.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_KALIMA3* lpInfo = &gMonsterSetBaseKalimaThree.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseKalimaThree::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_KALIMA3* lpInfo = &gMonsterSetBaseKalimaThree.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseKalimaThree.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
