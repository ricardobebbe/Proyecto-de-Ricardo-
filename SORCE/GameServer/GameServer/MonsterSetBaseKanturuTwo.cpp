// MonsterSetBase.cpp: implementation of the CMonsterSetBaseKanturuTwo class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseKanturuTwo gMonsterSetBaseKanturuTwo;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseKanturuTwo::CMonsterSetBaseKanturuTwo() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseKanturuTwo::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_KANTURU2 info;
...
void CMonsterSetBaseKanturuTwo::SetInfo(MONSTER_SET_BASE_INFO_KANTURU2 info) // OK
{
...
bool CMonsterSetBaseKanturuTwo::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_KANTURU2* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseKanturuTwo::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseKanturuTwo::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseKanturuTwo::SetMonsterDataKanturuTwo() // OK
{
	for (int n = 0; n < gMonsterSetBaseKanturuTwo.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_KANTURU2* lpInfo = &gMonsterSetBaseKanturuTwo.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseKanturuTwo::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_KANTURU2* lpInfo = &gMonsterSetBaseKanturuTwo.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseKanturuTwo.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
