// MonsterSetBase.cpp: implementation of the CMonsterSetBaseLandOfTrials class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseLandOfTrials gMonsterSetBaseLandOfTrials;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseLandOfTrials::CMonsterSetBaseLandOfTrials() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseLandOfTrials::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_LANDOFTRIALS info;
...
void CMonsterSetBaseLandOfTrials::SetInfo(MONSTER_SET_BASE_INFO_LANDOFTRIALS info) // OK
{
...
bool CMonsterSetBaseLandOfTrials::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_LANDOFTRIALS* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseLandOfTrials::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseLandOfTrials::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseLandOfTrials::SetMonsterDataLandOfTrials() // OK
{
	for (int n = 0; n < gMonsterSetBaseLandOfTrials.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_LANDOFTRIALS* lpInfo = &gMonsterSetBaseLandOfTrials.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseLandOfTrials::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_LANDOFTRIALS* lpInfo = &gMonsterSetBaseLandOfTrials.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseLandOfTrials.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
