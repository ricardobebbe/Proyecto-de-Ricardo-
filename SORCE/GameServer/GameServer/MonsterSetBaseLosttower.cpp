// MonsterSetBase.cpp: implementation of the CMonsterSetBaseLosttower class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseLosttower gMonsterSetBaseLosttower;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseLosttower::CMonsterSetBaseLosttower() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseLosttower::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_LOSTTOWER info;
...
void CMonsterSetBaseLosttower::SetInfo(MONSTER_SET_BASE_INFO_LOSTTOWER info) // OK
{
...
bool CMonsterSetBaseLosttower::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_LOSTTOWER* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseLosttower::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseLosttower::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseLosttower::SetMonsterDataLosttower() // OK
{
	for (int n = 0; n < gMonsterSetBaseLosttower.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_LOSTTOWER* lpInfo = &gMonsterSetBaseLosttower.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseLosttower::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_LOSTTOWER* lpInfo = &gMonsterSetBaseLosttower.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseLosttower.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
