// MonsterSetBase.cpp: implementation of the CMonsterSetBaseNoria class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseNoria gMonsterSetBaseNoria;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseNoria::CMonsterSetBaseNoria() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseNoria::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_NORIA info;
...
void CMonsterSetBaseNoria::SetInfo(MONSTER_SET_BASE_INFO_NORIA info) // OK
{
...
bool CMonsterSetBaseNoria::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_NORIA* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseNoria::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseNoria::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseNoria::SetMonsterDataNoria() // OK
{
	for (int n = 0; n < gMonsterSetBaseNoria.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_NORIA* lpInfo = &gMonsterSetBaseNoria.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseNoria::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_NORIA* lpInfo = &gMonsterSetBaseNoria.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseNoria.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
