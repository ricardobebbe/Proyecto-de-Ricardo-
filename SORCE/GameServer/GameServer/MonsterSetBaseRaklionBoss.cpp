// MonsterSetBase.cpp: implementation of the CMonsterSetBaseRaklionBoss class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseRaklionBoss gMonsterSetBaseRaklionBoss;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseRaklionBoss::CMonsterSetBaseRaklionBoss() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseRaklionBoss::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_RAKLIONBOSS info;
...
void CMonsterSetBaseRaklionBoss::SetInfo(MONSTER_SET_BASE_INFO_RAKLIONBOSS info) // OK
{
...
bool CMonsterSetBaseRaklionBoss::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_RAKLIONBOSS* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseRaklionBoss::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseRaklionBoss::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseRaklionBoss::SetMonsterDataRaklionBoss() // OK
{
	for (int n = 0; n < gMonsterSetBaseRaklionBoss.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_RAKLIONBOSS* lpInfo = &gMonsterSetBaseRaklionBoss.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseRaklionBoss::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_RAKLIONBOSS* lpInfo = &gMonsterSetBaseRaklionBoss.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseRaklionBoss.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
