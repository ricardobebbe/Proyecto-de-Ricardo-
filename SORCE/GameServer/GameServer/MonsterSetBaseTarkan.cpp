// MonsterSetBase.cpp: implementation of the CMonsterSetBaseTarkan class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseTarkan gMonsterSetBaseTarkan;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseTarkan::CMonsterSetBaseTarkan() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseTarkan::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_TARKAN info;
...
void CMonsterSetBaseTarkan::SetInfo(MONSTER_SET_BASE_INFO_TARKAN info) // OK
{
...
bool CMonsterSetBaseTarkan::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_TARKAN* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseTarkan::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseTarkan::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseTarkan::SetMonsterDataTarkan() // OK
{
	for (int n = 0; n < gMonsterSetBaseTarkan.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_TARKAN* lpInfo = &gMonsterSetBaseTarkan.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseTarkan::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_TARKAN* lpInfo = &gMonsterSetBaseTarkan.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseTarkan.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
