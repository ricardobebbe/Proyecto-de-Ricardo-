// MonsterSetBase.cpp: implementation of the CMonsterSetBaseVulcanus class.
//
//////////////////////////////////////////////////////////////////////
...
CMonsterSetBaseVulcanus gMonsterSetBaseVulcanus;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CMonsterSetBaseVulcanus::CMonsterSetBaseVulcanus() // OK
{
	this->m_count = 0;
}
...
void CMonsterSetBaseVulcanus::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			while (true)
			{
				...
				MONSTER_SET_BASE_INFO_VULCANUS info;
...
void CMonsterSetBaseVulcanus::SetInfo(MONSTER_SET_BASE_INFO_VULCANUS info) // OK
{
...
bool CMonsterSetBaseVulcanus::GetPosition(int index, short map, short* ox, short* oy) // OK
{
	...
	MONSTER_SET_BASE_INFO_VULCANUS* lpInfo = &this->m_MonsterSetBaseInfo[index];
...
bool CMonsterSetBaseVulcanus::GetBoxPosition(int map, int x, int y, int tx, int ty, short* ox, short* oy) // OK
{
	for (int n = 0; n < 100; n++)
	{
		int subx = tx - x;
...
void CMonsterSetBaseVulcanus::SetBoxPosition(int index, int map, int x, int y, int tx, int ty) // OK
{
	if (index < 0 || index >= MAX_MSB_MONSTER)
	{
		return;
...
void CMonsterSetBaseVulcanus::SetMonsterDataVulcanus() // OK
{
	for (int n = 0; n < gMonsterSetBaseVulcanus.m_count; n++)
	{
		MONSTER_SET_BASE_INFO_VULCANUS* lpInfo = &gMonsterSetBaseVulcanus.m_MonsterSetBaseInfo[n];
...
bool CMonsterSetBaseVulcanus::gObjSetPosMonster(int aIndex, int number) // OK
{
	...
	MONSTER_SET_BASE_INFO_VULCANUS* lpInfo = &gMonsterSetBaseVulcanus.m_MonsterSetBaseInfo[number];

	short x, y;

	if (gMonsterSetBaseVulcanus.GetPosition(number, lpInfo->Map, &x, &y) == 0)
	{
		return 0;
	}
