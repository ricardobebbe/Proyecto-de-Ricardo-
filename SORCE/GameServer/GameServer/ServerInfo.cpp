...
void CServerInfo::ReadCashShopInfo() // OK
{
	...
	LogAdd(LOG_GREEN,"[ServerInfo] CashShop Carregado Com Sucesso");
}
...
void CServerInfo::ReadChaosMixInfo() // OK
{
	...
	LogAdd(LOG_GREEN,"[ServerInfo] ChaosMix Carregado Com Sucesso");
}
...
void CServerInfo::ReadCharacterInfo() // OK
{
	...
	LogAdd(LOG_GREEN,"[ServerInfo] Character Carregado Com Sucesso");
}
...
void CServerInfo::ReadCommandInfo() // OK
{
	...
	gCommandManager.Load(gPath.GetFullPath("CommandManager.xml"));

	LogAdd(LOG_GREEN,"[ServerInfo] Command Carregado Com Sucesso");
}
...
void CServerInfo::ReadCommonInfo() // OK
{
	...
	LogAdd(LOG_GREEN,"[ServerInfo] Common Carregado Com Sucesso");
}
...
void CServerInfo::ReadCustomInfo() // OK
{
	...
	gCustomEventDrop.Load(gPath.GetFullPath("Custom\\CustomEvents\\CustomEventDrop.txt"));

	gCustomOnlineLottery.Load(gPath.GetFullPath("Custom\\CustomEvents\\CustomOnlineLottery.txt"));

	gCustomQuest.Load(gPath.GetFullPath("Custom\\CustomEvents\\CustomQuest.txt"));

	gCustomTop.Load(gPath.GetFullPath("Custom\\CustomRanking\\CustomTop.txt"));

	gCustomNpcCollector.Load(gPath.GetFullPath("Custom\\CustomNpc\\CustomNpcCollector.txt"));

	gCustomZeusMercador.Load(gPath.GetFullPath("Custom\\CustomZeusMercador.xml"));  //Zeus UP22 Custom ZeusMercador

	gCustomRankUser.Load(gPath.GetFullPath("Custom\\CustomRanking\\CustomRankUser.txt"));

	gCustomWingMix.Load(gPath.GetFullPath("Custom\\CustomMix\\CustomWingMix.txt"));

	gCustomMix.Load(gPath.GetFullPath("Custom\\CustomMix\\CustomMix.txt"));

	gCustomMarlon.Load(gPath.GetFullPath("Custom\\CustomNpc\\CustomMarlonTeleport.txt"));
	...
	gCustomQuiz.Load(gPath.GetFullPath("Custom\\CustomEvents\\CustomQuiz.txt"));

	gCustomPick.Load(gPath.GetFullPath("Custom\\CustomPick.txt"));

	gCustomRanking.Load(gPath.GetFullPath("Custom\\CustomRanking\\CustomRanking.txt"));
	...
	gCustomMonster.Load(gPath.GetFullPath("Custom\\CustomMonster\\CustomMonster.txt"));

	gCustomMonsterSkill.Load(gPath.GetFullPath("Custom\\CustomMonster\\CustomMonsterSkill.txt"));

	gCustomWing.Load(gPath.GetFullPath("Custom\\CustomWings Pets\\CustomWing.txt"));

	gCustomNpcMove.Load(gPath.GetFullPath("Custom\\CustomNpc\\CustomNpcMove.txt"));

	gCustomNpcCommand.Load(gPath.GetFullPath("Custom\\CustomNpc\\CustomNpcCommand.txt"));

	gItemValueTrade.Load(gPath.GetFullPath("Item\\ItemValueTrade.txt"));

	gCustomNpcQuest.Load(gPath.GetFullPath("Custom\\CustomNpc\\CustomNpcQuest.txt"));
//---------- cosas de pet
	gCustomPet.Load(gPath.GetFullPath("Custom\\CustomWings Pets\\CustomPet.txt"));

	//gCustomStartItem.Load(gPath.GetFullPath("Custom\\CustomStartItem.txt"));

	//gLuckyWheel.Load(gPath.GetFullPath("Custom\\CustomCasinoRoyale.txt"));  //ZEUS UP24 Cassino

	#if(START_ITEM==1)
	gGiftNew.Load(gPath.GetFullPath("Custom\\CustomStartItem.xml"));         //ZEUS UP22 CUSTOW BONUS ITENS V2
    #endif

	//LogAdd(LOG_GREEN,"[ServerInfo] Custom Carregado Com Sucesso");

	g_NewsBoard.Load();    //ZEUS UP19 NEW NOTICIAS

	#if USE_FAKE_ONLINE == TRUE //ZEUS UP18 FAKE
	s_FakeOnline.LoadFakeData(".\\FakeOnline\\FakeButs.xml");
    #endif
...
void CServerInfo::ReadEventInfo() // OK
{
	...
	gBonusManager.Load(gPath.GetFullPath("Event\\HappyHours.dat"));
	...
	gLuckyWheel.Init();    //ZEUS UP24 Cassino

	gRaklion.SetState(RAKLION_STATE_END);

	LogAdd(LOG_GREEN,"[ServerInfo] Event Carregado Com Sucesso");
}
...
void CServerInfo::ReadEventItemBagInfo() // OK
{
	...
	LogAdd(LOG_GREEN,"[ServerInfo] EventItemBag Carregado Com Sucesso");
}
...
void CServerInfo::ReadHackInfo() // OK
{
	...
	LogAdd(LOG_GREEN,"[ServerInfo] Hack Carregado Com Sucesso");
}
...
void CServerInfo::ReadItemInfo() // OK
{
	...
	LogAdd(LOG_GREEN,"[ServerInfo] Item Carregado Com Sucesso");
}
...
void CServerInfo::ReadMonsterInfo() // OK
{
	...
	gMonsterSetBase.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\000 - Lorencia.txt"));

	gMonsterSetBaseDungeon.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\001 - Dungeon.txt"));

	gMonsterSetBaseDevias.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\002 - Devias.txt"));

	gMonsterSetBaseNoria.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\003 - Noria.txt"));

	gMonsterSetBaseLosttower.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\004 - Losttower.txt"));

	gMonsterSetBaseArena.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\006 - Arena.txt"));

	gMonsterSetBaseAtlans.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\007 - Atlans.txt"));

	gMonsterSetBaseTarkan.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\008 - Tarkan.txt"));

	gMonsterSetBaseIcarus.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\010 - Icarus.txt"));

	gMonsterSetBaseKalimaOne.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\024 - Kalima 1.txt"));

	gMonsterSetBaseKalimaTwo.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\025 - Kalima 2.txt"));

	gMonsterSetBaseKalimaThree.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\026 - Kalima 3.txt"));

	gMonsterSetBaseKalimaFour.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\027 - Kalima 4.txt"));

	gMonsterSetBaseKalimaFive.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\028 - Kalima 5.txt"));

	gMonsterSetBaseKalimaSix.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\029 - Kalima 6.txt"));

	gMonsterSetBaseKalimaSeven.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\036 - Kalima 7.txt"));

	gMonsterSetBaseCastleSiege.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\030 - Castle Siege.txt"));

	gMonsterSetBaseLandOfTrials.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\031 - Land of Trials.txt"));

	//gMonsterSetBaseCrywolf.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\034 - Crywolf.txt"));

	//gMonsterSetBaseKanturuTwo.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\038 - Kanturu 2.txt"));

	//gKanturuMonsterMng.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Kanturu Event.txt"));

	gMonsterSetBaseBarracks.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\041 - Barracks.txt"));

	gMonsterSetBaseRefuge.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\042 - Refuge.txt"));

	//gMonsterSetBaseElbeland.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\051 - Elbeland.txt"));

	gMonsterSetBaseSwamp.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\056 - Swamp of Calmness.txt"));

	//gMonsterSetBaseRaklion.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\057 - Raklion 1.txt"));

	//gMonsterSetBaseRaklionBoss.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Raklion Boss.txt"));

	gMonsterSetBaseSantaTown.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\062 - Santa Town.txt"));

	gMonsterSetBaseVulcanus.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\063 - Vulcanus.txt"));

	gMonsterSetBaseLorenMarket.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\079 - Loren Market.txt"));

	//gMonsterSetBaseKarutanOne.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\080 - Karutan 1.txt"));

	//gMonsterSetBaseKarutanTwo.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\081 - Karutan 2.txt"));

	gMonsterSetBaseCustomOne.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\084 - Custom 01.txt"));

	gMonsterSetBaseCustomTwo.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\085 - Custom 02.txt"));

	gMonsterSetBaseCustomThe.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\086 - Custom 03.txt"));

	gMonsterSetBaseCustomFor.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\087 - Custom 04.txt"));

	gMonsterSetBaseCustomFiv.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\088 - Custom 05.txt"));

	gMonsterSetBaseCustomSix.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\089 - Custom 06.txt"));

	gMonsterSetBaseCustomSev.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\090 - Custom 07.txt"));

	gMonsterSetBaseCustomEig.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\095 - Custom 08.txt"));

	gMonsterSetBaseCustomNin.Load(gPath.GetFullPath("Monster\\MonsterSpawn\\096 - ArenaVip.txt"));

	gMonsterSetBaseBloodCastle.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Blood Castle 1.txt"));

	gMonsterSetBaseBloodCastleTwo.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Blood Castle 2.txt"));

	gMonsterSetBaseBloodCastleThe.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Blood Castle 3.txt"));

	gMonsterSetBaseBloodCastleFor.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Blood Castle 4.txt"));

	gMonsterSetBaseBloodCastleFiv.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Blood Castle 5.txt"));

	gMonsterSetBaseBloodCastleSix.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Blood Castle 6.txt"));

	gMonsterSetBaseBloodCastleSev.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Blood Castle 7.txt"));

	gMonsterSetBaseBloodCastleEig.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Blood Castle 8.txt"));
	   
	gMonsterSetBaseDevilSquareOne.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Devil Square 1.txt"));

	gMonsterSetBaseDevilSquareTwo.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Devil Square 2.txt"));

	gMonsterSetBaseChaosCastle.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Chaos Castle 1.txt"));

	gMonsterSetBaseChaosCastleTwo.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Chaos Castle 2.txt"));

	gMonsterSetBaseChaosCastleThe.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Chaos Castle 3.txt"));

	gMonsterSetBaseChaosCastleFor.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Chaos Castle 4.txt"));

	gMonsterSetBaseChaosCastleFiv.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Chaos Castle 5.txt"));

	gMonsterSetBaseChaosCastleSix.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Chaos Castle 6.txt"));

	gMonsterSetBaseChaosCastleSev.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Chaos Castle 7.txt"));
	
	//gMonsterSetBaseIllusionOne.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Illusion Temple 1.txt"));

	//gMonsterSetBaseIllusionTwo.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Illusion Temple 2.txt"));

	//gMonsterSetBaseIllusionThe.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Illusion Temple 3.txt"));

	//gMonsterSetBaseIllusionFor.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Illusion Temple 4.txt"));

	//gMonsterSetBaseIllusionFiv.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Illusion Temple 5.txt"));

	//gMonsterSetBaseIllusionSix.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Illusion Temple 6.txt"));
	
	gMonsterSetBaseImperialOne.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Imperial Guardian 1.txt"));

	gMonsterSetBaseImperialTwo.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Imperial Guardian 2.txt"));

	gMonsterSetBaseImperialThe.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Imperial Guardian 3.txt"));

	gMonsterSetBaseImperialFor.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Imperial Guardian 4.txt"));

	gMonsterSetBaseInvasion.Load(gPath.GetFullPath("Monster\\MonsterEvent\\Invasion Manager.txt"));
	...
	LogAdd(LOG_GREEN,"[ServerInfo] Monster Carregado Com Sucesso");
}
...
void CServerInfo::ReadMoveInfo() // OK
{
	...
	LogAdd(LOG_GREEN,"[ServerInfo] Move Carregado Com Sucesso");
}
...
void CServerInfo::ReadQuestInfo() // OK
{
	...
	LogAdd(LOG_GREEN,"[ServerInfo] Quest Carregado Com Sucesso");
}
...
void CServerInfo::ReadScriptInfo() // OK
{
	...
	LogAdd(LOG_GREEN,"[ServerInfo] ScriptMain Lua Carregado Com Sucesso");
}
...
void CServerInfo::ReadShopInfo() // OK
{
	...
	LogAdd(LOG_GREEN,"[ServerInfo] Shop Carregado Com Sucesso");
}
...
void CServerInfo::ReadSkillInfo() // OK
{
	...
	gSkillDamage.Load(gPath.GetFullPath("Skill\\SkillDamage.txt"));   //ZEUS UP24 Custom Skill Damage System

	LogAdd(LOG_GREEN,"[ServerInfo] Skill Carregado Com Sucesso");
}
...
void CServerInfo::ReadUtilInfo() // OK
{
	...
	LogAdd(LOG_GREEN,"[ServerInfo] Util Carregado Com Sucesso");
}
...
void CServerInfo::ReloadBotInfo() // OK
{
	...
	ObjBotBuff.MakeBot();
#endif
		LogAdd(LOG_GREEN,"[ReadBotInfo] BotSystem Carregado Com Sucesso");
...
void CServerInfo::ReloadMonsterInfo() // OK
{
	...
	//Leitura de todos as aloca��es de spots
...
void CServerInfo::ReadCommandInfo(char* section,char* path) // OK
{
	...
	this->m_CommandPostTypeVip = GetPrivateProfileInt(section,"CommandPostTypeVip",0,path);

	this->m_CommandPostType = GetPrivateProfileInt(section,"CommandPostType",0,path); //ZEUS UP19 FIXO COLOR POST
...
void CServerInfo::ReadCommonInfo(char* section,char* path) // OK
{
	...
	this->m_ElfBufferEnableQuest = GetPrivateProfileInt(section,"ElfBufferEnableQuest",0,path);  //ZEUS UP19 QUEST ELF DONWGRAND
	...
	this->m_ElfBufferTime[0] = GetPrivateProfileInt(section, "ElfBufferTime_AL0", 0, path);      //ZEUS UP19 QUEST ELF DONWGRAND
	...
	this->m_PotionDelay = GetPrivateProfileInt(section, "PotionDelay", 0, path);  //ZEUS UP20 POTIONS DALEY
...
void CServerInfo::ReadCustomInfo(char* section,char* path) // OK
{
	...
	this->m_CustomZeusMercadorSwitch    = GetPrivateProfileInt(section, "CustomZeusMercadorSwitch", 0, path);      //Zeus UP22 Custom ZeusMercador
	this->m_CustomZeusMercadorEnable[0] = GetPrivateProfileInt(section, "CustomZeusMercadorEnable_AL0 ", 0, path); //Zeus UP22 Custom ZeusMercador
	this->m_CustomZeusMercadorEnable[1] = GetPrivateProfileInt(section, "CustomZeusMercadorEnable_AL1 ", 0, path); //Zeus UP22 Custom ZeusMercador
	this->m_CustomZeusMercadorEnable[2] = GetPrivateProfileInt(section, "CustomZeusMercadorEnable_AL2 ", 0, path); //Zeus UP22 Custom ZeusMercador
	this->m_CustomZeusMercadorEnable[3] = GetPrivateProfileInt(section, "CustomZeusMercadorEnable_AL3", 0, path);  //Zeus UP22 Custom ZeusMercador
	...
	this->NewsWindowOnLogin		    = GetPrivateProfileInt(section,"NewsWindowOnLogin",0,path);  //ZEUS UP20 PAINEL NOTICIAS IN-GAME GS

	this->LuckyWheelSwitch = GetPrivateProfileInt(section, "LuckyWheelSwitch", 0, path);   //ZEUS UP24 Cassino

	this->LuckyWheelMoney = GetPrivateProfileInt(section,"LuckyWheelWcoinsValue",0,path);  //ZEUS UP24 Cassino
}
...
void CServerInfo::ReadHackInfo(char* section,char* path) // OK
{
	...
	this->DeleteDupeItem = GetPrivateProfileInt(section, "DeleteDupeItem", 0, path);       //ZEUS UP22 ANTDUPER
	this->DisconectDupeItem = GetPrivateProfileInt(section, "DisconectDupeItem", 0, path); //ZEUS UP22 ANTDUPER
