...
public:
	...
	void ReadMoveInfo();
	void ReadQuestInfo();
	void ReadScriptInfo(); //ZEUS UP24 LUA
	int m_Debugger;        //ZEUS UP24 LUA
	void ReadShopInfo();
	void ReadSkillInfo();
	void ReadUtilInfo();
...
public:
	...
	int m_ElfBufferTime[MAX_ACCOUNT_LEVEL];  //ZEUS UP19 QUEST ELF DONWGRAND
	...
	int m_PotionDelay;    //ZEUS UP20 POTIONS DALEY
	...
	////Zeus UP22 Custom ZeusMercador Collector
	int m_CustomZeusMercadorSwitch;
	int m_CustomZeusMercadorEnable[MAX_ACCOUNT_LEVEL];
	...
	int m_CommandPostTypeVip;
	int NewsWindowOnLogin; //ZEUS UP20 PAINEL DE NOTICIA IN-GAME GS
	//ZEUS UP24 Cassino
	int LuckyWheelSwitch;
	int LuckyWheelMoney;
};
