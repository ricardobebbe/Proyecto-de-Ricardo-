...
{
	// =====================================================================================================
//                DrawMessage - TEXTO DE ENTRADA NO CLIENTE UP16
// =====================================================================================================
	pDrawMessage("Sea Bin Vindo", 0);
	pDrawMessage("[-- Preparamos Um Servidor Totalmente Inovador --]", 1);
	pDrawMessage("[-- Siempre Adesposision --]", 2);
...
// =====================================================================================================
	...
	pLoadImage("Custom\\Interface\\NewsBoard_Title.tga", 0x787D, 0x2601, 0x2900, 1, 0); //ZEUS UP19 NEW NOTICIAS
	...
	case 1:
	case 2:
		pLoadImage("Custom\\Interface97\\Menu\\ePointback.jpg", 0x700020, 0x2601, 0x2901, 1, 0);
		//--
		LoadBitmapA("Custom\\Interface97\\Item_Back01.tga", 61522, GL_LINEAR, GL_CLAMP, 1, 0);
		LoadBitmapA("Custom\\Interface\\none.tga", 51522, GL_LINEAR, GL_CLAMP, 1, 0);
		//--
		LoadBitmapA("Custom\\Interface97\\DragonRight.tga", 2336, GL_LINEAR, GL_CLAMP, 1, 0);
		LoadBitmapA("Custom\\Interface97\\DragonLeft.tga", 2337, GL_LINEAR, GL_CLAMP, 1, 0);
		//--
		if(gProtect.m_MainInfo.CustomInterfaceType == 1)
		{
			LoadBitmapA("Custom\\Interface97\\Menu_left97.jpg", 31292, GL_LINEAR, GL_CLAMP, 1, 0); //replace
			LoadBitmapA("Custom\\Interface\\none.tga", 31300, GL_LINEAR, GL_CLAMP, 1, 0);
		}else
		{
			LoadBitmapA("Custom\\Interface97\\Menu_left.jpg", 31292, GL_LINEAR, GL_CLAMP, 1, 0); //replace
			LoadBitmapA("Custom\\Interface97\\Menu_SD.jpg", 31300, GL_LINEAR, GL_CLAMP, 1, 0);
		}

		LoadBitmapA("Custom\\Interface97\\Menu_right.jpg", 31294, GL_LINEAR, GL_CLAMP, 1, 0); //replace
		LoadBitmapA("Custom\\Interface97\\Menu_middle.jpg", 31293, GL_LINEAR, GL_CLAMP, 1, 0); //replace
		//--
		LoadBitmapA("Custom\\Interface97\\Menu_Red.jpg", 0x7A42, GL_LINEAR, GL_CLAMP, 1, 0);//replace
		LoadBitmapA("Custom\\Interface97\\Menu_Green.jpg", 0x7A41, GL_LINEAR, GL_CLAMP, 1, 0);//replace
		LoadBitmapA("Custom\\Interface97\\Menu_Blue.jpg", 0x7A40, GL_LINEAR, GL_CLAMP, 1, 0);//replace
		LoadBitmapA("Custom\\Interface97\\Menu_AG.jpg", 31299, GL_LINEAR, GL_CLAMP, 1, 0);
		//--
		LoadBitmapA("Custom\\Interface97\\Boton\\Menu_fastmenu.jpg", iNewFastMenu, GL_LINEAR, GL_CLAMP, 1, 0);
		LoadBitmapA("Custom\\Interface\\none.tga", 31295, GL_LINEAR, GL_CLAMP, 1, 0); //replace
		LoadBitmapA("Custom\\Interface97\\Boton\\Menu_Inventory.jpg", iNewInventory, GL_LINEAR, GL_CLAMP, 1, 0);
		LoadBitmapA("Custom\\Interface97\\Boton\\Menu_Character.jpg", iNewCharacter, GL_LINEAR, GL_CLAMP, 1, 0);
		LoadBitmapA("Custom\\Interface97\\Boton\\Menu_Party.jpg", iNewParty, GL_LINEAR, GL_CLAMP, 1, 0);
		LoadBitmapA("Custom\\Interface97\\Boton\\Menu_friend.jpg", iNewWinpush, GL_LINEAR, GL_CLAMP, 1, 0);
		LoadBitmapA("Custom\\Interface97\\Boton\\Menu_guild.jpg", iNewGuild, GL_LINEAR, GL_CLAMP, 1, 0);
		//--
		LoadBitmapA("Custom\\Interface97\\skillboxR.jpg", 0x700003, 0x2601, 0x2901, 1, 0);
		LoadBitmapA("Custom\\Interface97\\newui_skill.jpg", 31308, GL_LINEAR, GL_CLAMP, 1, 0);
		...
		//--
		//Interface Character
		LoadBitmapA("Custom\\Interface97\\Menu\\Stats.jpg", 31352, GL_LINEAR, GL_CLAMP, 1, 0);
		LoadBitmapA("Custom\\Interface97\\Menu\\StatsDL.jpg", 51291, GL_LINEAR, GL_CLAMP, 1, 0);
		LoadBitmapA("Custom\\Interface97\\Menu\\Stats2.jpg", 51292, GL_LINEAR, GL_CLAMP, 1, 0);
		LoadBitmapA("Custom\\Interface97\\Menu\\Level_box.jpg", 35353, GL_LINEAR, GL_CLAMP, 1, 0);
		LoadBitmapA("Custom\\Interface97\\Menu\\Level_button.jpg", 51290, GL_LINEAR, GL_CLAMP, 1, 0);
		LoadBitmapA("Custom\\Interface97\\Menu\\ePointback.jpg", 0x700020, 0x2601, 0x2901, 1, 0);
		//-- chat
		LoadBitmapA("Custom\\Interface97\\chat\\nis_vframe.jpg", 51551, GL_LINEAR, GL_CLAMP, 1, 0);
		...
		LoadBitmapA("Custom\\Interface97\\Chat\\dialogue1.tga", 51530, GL_LINEAR, GL_CLAMP, 1, 0);
		LoadBitmapA("Custom\\Interface97\\Chat\\dialogue2.tga", 51531, GL_LINEAR, GL_CLAMP, 1, 0);
		LoadBitmapA("Custom\\Interface97\\Chat\\dialogue2_1.jpg", 51532, GL_LINEAR, GL_CLAMP, 1, 0);
		pLoadImage("Custom\\Interface97\\chat\\btnChatOn.jpg", 0x700021, GL_LINEAR, GL_CLAMP, 1, 0);   //ZEUS UP23 CHAT CLASSIC 97D
		pLoadImage("Custom\\Interface97\\chat\\btnWinSize.jpg", 0x700022, GL_LINEAR, GL_CLAMP, 1, 0);  //ZEUS UP23 CHAT CLASSIC 97D
		pLoadImage("Custom\\Interface97\\chat\\btnAlpha.jpg", 0x700023, GL_LINEAR, GL_CLAMP, 1, 0);    //ZEUS UP23 CHAT CLASSIC 97D
		pLoadImage("Logo\\Mu-logo_g.jpg",  531019, GL_LINEAR, GL_REPEAT, 1, 0);                        //ZEUS UP23 FIXO TROCA DA LOGO
	    pLoadImage("Logo\\Mu-logo.tga",  531018, GL_LINEAR, GL_REPEAT, 1, 0);                          //ZEUS UP23 FIXO TROCA DA LOGO

		pLoadImage("Custom\\PartyLat.jpg", 79124, 0x2601, 0x2901, 1, 0);	   //ZEUS UP23 party
		pLoadImage("Custom\\PartyFrame.jpg", 79125, 0x2601, 0x2901, 1, 0);	   //ZEUS UP23 party
		pLoadImage("Custom\\PartyProgress.tga", 79126, 0x2601, 0x2901, 1, 0);  //ZEUS UP23 trás
...
LOAD_GFX:
	...
	pDrawMessage(Notice_1, 0); //ZEUS UP19 PANEL BEM VINDAS CLIENT
...
//ZEUS UP18 PAINEL DESCRIÇÃO MAIN

void Interface::codeZEUS() 
{
    char test[500];
    sprintf_s(test, sizeof(test), " %s || Player: %s || Level: %d || Reset: %d ||", gProtect.m_MainInfo.WindowName, gObjUser.lpPlayer->Name, gObjUser.lpPlayer->Level, ViewReset);
...
void Interface::Work()
{
    ...
    gInterface.codeZEUS();         //ZEUS UP18 PAINEL DESCRIÇÃO MAIN

	g_PersonalShopEx.Draw();      //ZEUS UP24 Mercado Negro IN-GAME STORE

	// Advanced Stats
	g_StatsAdvance.DrawInfo();
	//--
	//gNewsBoard.DrawNewsWindow();   //ZEUS UP19 NEW NOTICIAS - ELIMINADO
	...
	if( GetForegroundWindow() == pGameWindow )
	{
		...
		if (GetKeyState('N') & 0x4000)  //ZEUS UP19 NEW NOTICIAS
		{
			...
			{
			//gNewsBoard.ReqOpenMain();	// COMENTADO: Archivo huérfano NewsBoard.h no disponible
			}
		}
	...
	if(gProtect.m_MainInfo.CustomInterfaceType != 3 || gProtect.m_MainInfo.CustomInterfaceType != 4)
	{
		pSetCursorFocus = false;
			...
			if (g_PersonalShopEx.CheckStoreWindow())      //ZEUS UP24 Mercado Negro IN-GAME STORE
			{
				g_PersonalShopEx.CloseStoreWindow();      //ZEUS UP24 Mercado Negro IN-GAME STORE
			}
...
bool Interface::IsWorkZone(float X, float Y, float MaxX, float MaxY, bool a5)  //ZEUS UP19 NEW NOTICIAS
{
	if (a5) 
	{
