...
char CustomPet::PetHPBar(int a1, int a2)
{
	...
	if( gProtect.m_MainInfo.CustomInterfaceType == 0 || gProtect.m_MainInfo.CustomInterfaceType == 1 || gProtect.m_MainInfo.CustomInterfaceType == 2 || gProtect.m_MainInfo.CustomInterfaceType == 3 || gProtect.m_MainInfo.CustomInterfaceType == 4 )
	{
		...
		else if( gProtect.m_MainInfo.CustomInterfaceType != 1 && gProtect.m_MainInfo.CustomInterfaceType != 2 && gProtect.m_MainInfo.CustomInterfaceType != 3 )
		{
	...
	if (*(BYTE *)(a1 + 4))
	{
		...
		if (Model)
		{
			...
			{                            
				...
				if ((SkinID >= ITEM2(13, 200) && SkinID <= ITEM2(13,) || SkinID <= ITEM2 (13, 280)) && gCustomPet2.GetInfoPetType(SkinID - 1171) == 8)
				{
					gCustomPet.PetFollowCharacter(a1, -180);//150 Distancia Safe

					switch (SkinID)
					{
					case ITEM2(13, 226): //King
					case ITEM2(13, 212): //King
					case ITEM2(13, 204): //Prince
					//case ITEM2(13, 282): //Prince =)) lazy
					*(float*)(a1 + 260) = *(float*)(*(DWORD*)(a1 + 472) + 260) + 40.0f;
					break;
					case ITEM2(13, 214): //Hawk
					case ITEM2(13, 215): //Hawk Evo
					case ITEM2(13, 202): //CherryBlossom
				...
				else if ((SkinID >= ITEM2(13, 281) && SkinID <= ITEM2(13, 410)) && gCustomPet2.GetInfoPetType(SkinID - 1171) == 8)//muun
				//if ((SkinID >= ITEM2(13,) && SkinID <= ITEM2 (12,200) || SkinID <= ITEM2 (13, 204) || SkinID <= ITEM2 (12,226)   && gCustomPet2.GetInfoPetType( SkinID - 1171 ) == 8|| gCustomPet2.GetInfoPetType( SkinID - 1171 ) ==9)) // ||9ZEUS UP23 Fix MuunPets Mover Corvo Junto COM Char 
				{
					
                   gCustomPet.PetFollowCharacter(a1, 350);
					switch (SkinID)
					{
					case ITEM2(13, 202): //CherryBlossom
					case ITEM2(13, 226): //DISTANCIA DOSMUUNPETS 
					case ITEM2(13, 204): //King
					case ITEM2(13, 212): //King
					//case ITEM2(13, 281): //Prince
					//case ITEM2(13, 282): //Prince =)) lazy
					*(float*)(a1 + 260) = *(float*)(*(DWORD*)(a1 + 472) + 60) + 40.0f; //mexi aqui
					break;
					case ITEM2(13, 214): //Hawk
					case ITEM2(13, 215): //Hawk Evo
					...
					case ITEM2(13, 179): //Chrysanthemum Evo
					case ITEM2(13, 200): //Ghost
					*(float*)(a1 + 260) = *(float*)(*(DWORD*)(a1 + 472) + 260) + 30.0f; //mexi aqui
						break;
					case ITEM2(13, 201): //Ghost Evo
						*(DWORD *)(a1 + 68) = 1;
						*(float *)(a1 + 260) = *(float*)(*(DWORD*)(a1 + 472) + 260) + 30.0f;
			...
			{
				if ((SkinID >= ITEM2(13, 281) && SkinID <= ITEM2(13, 410)) && gCustomPet2.GetInfoPetType(SkinID - 1171) == 8)
				//if ((SkinID >= ITEM2(13,) && SkinID <= ITEM2 (12,200) || SkinID <= ITEM2 (13, 204) || SkinID <= ITEM2 (12,226)   && gCustomPet2.GetInfoPetType( SkinID - 1171 ) == 8|| gCustomPet2.GetInfoPetType( SkinID - 1171 ) ==9)) // ||9ZEUS UP23 Fix MuunPets Mover Corvo Junto COM Char 
				{
					gCustomPet.PetFollowCharacter(a1, 85); //SEGUINDO FORA SAFE

					switch (SkinID)
					{
					case ITEM2(13, 283): //CherryBlossom
					case ITEM2(13, 226):
					case ITEM2(13, 212): //King
					case ITEM2(13, 281): //Prince
