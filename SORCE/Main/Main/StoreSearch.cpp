...
void PersonalShopEx::Draw()
{
	...
	if (gInterface.IsWorkZone(ePT_PERSONAL_SEARCH_CLOSE))
	{
		...
		gInterface.DrawToolTip(gInterface.Data[ePT_PERSONAL_SEARCH_CLOSE].X + 5, gInterface.Data[ePT_PERSONAL_SEARCH_CLOSE].Y + 25, "Fechar");
	}
	
	gInterface.DrawFormat(eGold, ContentX + 10, ContentY + 8, 210, 3, "MERCADO NEGRO");
	...
	gInterface.DrawFormat(eGold, ListDrawX + 8, ListDrawY + 20, 100, 1, "Player");
	ListDrawX += 50;
	gInterface.DrawFormat(eGold, ListDrawX + 13, ListDrawY + 20, 100, 1, "Tipo De Moeda");
	ListDrawX += 50;
	ListDrawX += 15;
	ListDrawX += 20;
	ListDrawX += 35;
	...
	gInterface.DrawFormat(eGold, ContentX+90, ContentY + 329, 100, 1, "Proximo: %d/%d", this->Page+1,(this->TotalShop-1)/10+1);
}
// ----------------------------------------------------------------------------------------------
